        ...
        private List<Product> Products
        {
            get
            {
                if (HttpContext.Current.Cache["__products"] == null)
                    HttpContext.Current.Cache["__products"] = ProductsRepository.Products.ToList();

                return HttpContext.Current.Cache["__products"] as List<Product>;
            }
            ...
            set
            {
                ...
                var products = ((List<Product>)HttpContext.Current.Cache["__products"]);
                products = value;
            }
        }
